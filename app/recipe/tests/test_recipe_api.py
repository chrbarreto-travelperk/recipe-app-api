...
def sample_recipe(user, **params):
    ...
    defaults.update(params)  # updates the params based on the dictionary
...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_retrieve_recipes(self):
        """Test retrieve a list of reciles"""
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_upload_image_bad_resquest(self):
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='Thai veg')
